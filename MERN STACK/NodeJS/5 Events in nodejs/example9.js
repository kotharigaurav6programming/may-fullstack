...
eventEmitter.on('myEvent1',listenerFunction1);
eventEmitter.on('myEvent1',listenerFunction2);
eventEmitter.on('myEvent2',listenerFunction3);
eventEmitter.on('myEvent2',listenerFunction4);
eventEmitter.removeListener("myEvent1",listenerFunction1);
